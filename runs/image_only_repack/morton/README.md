...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| FullLoad | 100% | 62.1% | 756.8 ms | 754.8 ms | 945.1 ms | 28.3 ms | 785.1 ms | 1165.1 MB |
| Layout+Prefix | 25% | 2.9% | 289.2 ms | 288.9 ms | 342.6 ms | 259.6 ms | 548.8 ms | 306.1 MB |
...
```bash
/home/dblab/anaconda3/envs/mllm_ft/bin/python scripts/04_eval.py --index data/index.json --store kvstore_image_only_work --limit 40 --questions 6 --skip 4 --ratio 0.25 --budget 0.25 --selectors layout_prefix_chunk --prefix-layout morton --sep-policy sidecar --metric gqa --dataset gqa --expect-images 40 --expect-questions 240 --no-recompute --run-dir runs/image_only_repack/morton
```
