...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| FullLoad | 100% | 63.3% | 736.2 ms | 728.6 ms | 935.4 ms | 28.4 ms | 764.6 ms | 1165.1 MB |
| Layout+Prefix | 25% | 60.8% | 290.4 ms | 288.9 ms | 344.3 ms | 25.9 ms | 316.4 ms | 306.1 MB |
...
```bash
/home/dblab/anaconda3/envs/mllm_ft/bin/python scripts/04_eval.py --index data/index.json --store kvstore_image_only_work --limit 40 --questions 6 --skip 4 --ratio 0.25 --budget 0.25 --selectors layout_prefix_chunk --prefix-layout calib_importance_sep_tail --sep-policy sidecar --metric gqa --dataset gqa --expect-images 40 --expect-questions 240 --no-recompute --run-dir runs/image_only_repack/calib4_sep_tail
```
