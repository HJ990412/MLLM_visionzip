...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| FullLoad | 100% | 62.1% | 782.1 ms | 806.9 ms | 957.9 ms | 28.7 ms | 810.8 ms | 1165.1 MB |
| Layout+Prefix | 25% | 2.9% | 289.1 ms | 286.4 ms | 342.1 ms | 259.4 ms | 548.5 ms | 306.1 MB |
...
```bash
/home/dblab/anaconda3/envs/mllm_ft/bin/python scripts/04_eval.py --index data/index.json --store kvstore_image_only_work --limit 40 --questions 6 --skip 4 --ratio 0.25 --budget 0.25 --selectors layout_prefix_chunk --prefix-layout raster --sep-policy sidecar --metric gqa --dataset gqa --expect-images 40 --expect-questions 240 --no-recompute --run-dir runs/image_only_repack/raster
```
